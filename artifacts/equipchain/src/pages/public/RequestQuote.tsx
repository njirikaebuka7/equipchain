...
export function RequestQuote() {
  ...
  return (
    <div className="w-full bg-background min-h-screen">
      <section className="relative pt-32 pb-20 bg-[#1a1a2e] text-white">
        <div className="absolute inset-0 bg-gradient-to-r from-[#0b0d82]/80 to-transparent" />
          ...
          {isSuccess ? (
            ...
            >
              ...
              <button 
                ...
                className="px-8 py-3 bg-[#0b0d82] text-white rounded-md font-semibold hover:bg-[#0b0d82]/90 transition-colors"
              >
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem className="mt-4">
                                    ...
                                    <FormControl>
                                      <Input placeholder="Describe the service needed" {...field} className="h-12" />
                                    </FormControl>
                                    <FormMessage />
                                  </FormItem>
                                )}
                        ...
                        >
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <Input placeholder="e.g. Centrifugal Pumps" {...field} className="h-12" />
                                  </FormControl>
                                </FormItem>
                              )}
                            />
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <Input placeholder="e.g. 5 units" {...field} className="h-12" />
                                  </FormControl>
                                </FormItem>
                              )}
                            />
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Textarea placeholder="Technical details, part numbers, or specific requirements..." className="min-h-[100px]" {...field} />
                                </FormControl>
                              </FormItem>
                            )}
                          />
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  <FormLabel>Required Delivery Timeline</FormLabel>
                                  <FormControl>
                                    <Input placeholder="e.g. 2 weeks, ASAP" {...field} className="h-12" />
                                  </FormControl>
                                </FormItem>
                              )}
                            />
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <div className="p-6 border-2 border-dashed border-border rounded-xl bg-secondary/50 text-center">
                                  ...
                                  <FormControl>
                                    <Input placeholder="https://" {...field} className="max-w-md mx-auto h-12" />
                                  </FormControl>
                                </div>
                              </FormItem>
                            )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Textarea placeholder="Any other details we should know?" className="min-h-[120px]" {...field} />
                                </FormControl>
                              </FormItem>
                            )}
                          />
                    ...
                    <div className="flex items-center justify-between pt-8 border-t border-border">
                      ...
                      {step < 5 ? (
                        <button
                          type="button"
                          onClick={handleNext}
                          className="inline-flex items-center justify-center rounded-md text-base font-semibold transition-colors focus-visible:outline-none bg-[#0b0d82] text-white hover:bg-[#0b0d82]/90 h-12 px-8"
                        >
                        ...
                        <button
                          ...
                          className="inline-flex items-center justify-center rounded-md text-base font-semibold transition-colors focus-visible:outline-none bg-[#f97316] text-white hover:bg-[#f97316]/90 h-12 px-10 shadow-lg disabled:opacity-70"
                        >
